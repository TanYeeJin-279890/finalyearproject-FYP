// ignore_for_file: prefer_interpolation_to_compose_strings, unused_label

import 'dart:convert';

//import 'package:androidx/views/views/ques.dart';
import 'package:androidx/views/fix.dart';
import 'package:androidx/views/views/mainscrn_withoutLogin.dart';
      ...
      http.post(Uri.parse(CONSTANTS.server + "/dys_server/php/login.php"),
        ...
        if (response.statusCode == 200 && logindata['status'] == 'success') {
          ...
          Navigator.pushReplacement(
              context,
              MaterialPageRoute(
                  builder: (content) => const MainScreenWithoutLogin()));
        } else {
          Fluttertoast.showToast(
              msg: "Failed",
              toastLength: Toast.LENGTH_SHORT,
