...
if ($number_of_result > 0) {
	...
	$cartqty = $cartqty + 1;
	$updatecart = "UPDATE `tbl_cart` SET `cart_qty`= '$cartqty' WHERE user_email = '$useremail' AND subject_id = '$subid' AND cart_status IS NULL";
	$conn->query($updatecart);
} 
else 
{
    $addcart = "INSERT INTO `tbl_cart`(`user_email`, `subject_id`, `cart_qty`) VALUES ('$useremail','$subid','$cartqty')";
